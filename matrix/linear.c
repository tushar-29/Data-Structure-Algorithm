...
int menu_driven()
{
    ...
    {
        case 1:
            printf("\n\tINSERTION at given position of the Linear Linked List\n\n");
        ...
        case 2:
            printf("\n\tINSERTION at last position of the Linear Linked List\n\n");
            printf("\nEnter the number to insert : ");
            scanf("%d", &num);
        ...
        case 3:
            printf("\n\tDELETION at last position of the Linear Linked List\n\n");
            pos = -1;
            num = del_node(pos);
            if(num != -1)
                printf("\n%d has been deleted.\n", num);
        ...
        case 4:
            printf("\n\tDELETION at given position of the Linear Linked List\n\n");
